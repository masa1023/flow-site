...
const technologies = [
  {
    ...
    icon: Cpu,
    items: ['TensorFlow', 'PyTorch', 'OpenAI GPT', 'Anthropic Claude', 'Hugging Face', 'LangChain'],
  ...
  },
  {
    ...
    icon: BarChart3,
    items: ['PostgreSQL', 'MongoDB', 'Redis', 'Apache Spark', 'Elasticsearch', 'BigQuery'],
  ...
  },
  {
    ...
    icon: Shield,
    items: ['OAuth 2.0', 'JWT', 'GDPR', 'SOC 2', 'ISO 27001', 'End-to-end encryption'],
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto text-lg">
            Our team stays at the forefront of technology, working with the latest 
            tools and frameworks to deliver state-of-the-art AI solutions.
          </p>
        </motion.div>
          ...
          {technologies.map((tech, index) => (
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                <div className={`inline-flex w-10 h-10 rounded-lg items-center justify-center ${tech.color} group-hover:scale-110 transition-transform`}>
