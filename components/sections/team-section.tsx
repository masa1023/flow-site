      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto text-lg">
            Our diverse team of AI experts, researchers, and business strategists 
            brings together decades of experience from leading tech companies and research institutions.
          </p>
        </motion.div>
