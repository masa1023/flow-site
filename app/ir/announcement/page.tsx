...
export const metadata: Metadata = {
  ...
  description: 'Latest investor relations announcements, financial reports, and corporate updates from Flow Inc.',
};
...
const announcements = [
  {
    ...
    summary: 'Flow Inc reported strong Q4 2023 results with 150% year-over-year revenue growth, driven by increased demand for AI development services.',
    status: 'Published',
  ...
  },
  {
    ...
    date: '2024-01-15',
    type: 'Funding',
    summary: 'Flow Inc successfully completed its Series A funding round, raising $25M to accelerate product development and market expansion.',
    status: 'Published',
  ...
  },
  {
    ...
    date: '2024-01-10',
    type: 'Partnership',
    summary: 'Flow Inc announces strategic partnership with TechCorp Inc. to deliver AI solutions to Fortune 500 companies.',
    status: 'Published',
  ...
  },
  {
    ...
    date: '2024-01-05',
    type: 'Leadership',
    summary: 'Flow Inc welcomes Dr. Sarah Martinez as Chief Technology Officer, bringing extensive experience in AI research and development.',
    status: 'Published',
  ...
  },
  {
    ...
    date: '2023-10-30',
    type: 'Financial Report',
    summary: 'Flow Inc reported record Q3 2023 results with 120% year-over-year revenue growth and expanded client base.',
    status: 'Published',
    ...
    <div className="min-h-screen pt-16">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground">
              Stay updated with Flow Inc's latest announcements, financial reports, 
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <Card>
            <CardContent className="p-6 text-center">
              <div className="text-3xl font-bold text-emerald-500 mb-2">$25M</div>
